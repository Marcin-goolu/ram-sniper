...
# ==========================================
# 1. KONFIGURACJA OGÓLNA (RAPORTY _PARALLEL)
# ==========================================

USER_DATA_DIR = "./chrome_profile_multi"
# Zmiana nazw plików na wersję _parallel
...
PARSERS = {
    "parse_xkom": parse_xkom, 
    "parse_morele": parse_morele,
    "parse_sferis": parse_sferis,
    "parse_oleole": parse_oleole,
    "parse_mediaexpert": parse_mediaexpert,
    "parse_komputronik": parse_komputronik
}
...
SCENARIOS = [
    # --- X-KOM ---
    {
        ...
        "page_param": "&page=", "cookie_texts": ["W porządku", "Akceptuję"], "parser_func": "parse_xkom", "max_pages": 50
    },
    {
    ...
    # --- MORELE ---
    {
        ...
        "cookie_texts": ["Zgadzam się", "Akceptuję"], "parser_func": "parse_morele", "max_pages": 50
    },
    {
    ...
    # --- SFERIS ---
    {
        ...
        "page_param": "&p=", "cookie_texts": ["Akceptuję", "Zgadzam się"], "parser_func": "parse_sferis", "max_pages": 50
    },
    {
    ...
    # --- OLEOLE ---
    {
        ...
        "cookie_texts": ["Akceptuj", "Zamknij"], "parser_func": "parse_oleole", "max_pages": 50
    },
    {
    ...
    # --- MEDIA EXPERT ---
    {
        ...
        "page_param": "&page=", "cookie_texts": ["Akceptuj", "Zaakceptuj"], "parser_func": "parse_mediaexpert", "max_pages": 50
    },
    {
    ...
    # --- KOMPUTRONIK ---
    {
        ...
        "page_param": "&p=", "cookie_texts": ["Akceptuję", "Zgadzam się"], "parser_func": "parse_komputronik", "max_pages": 50
    },
    {
...
async def run_cycle():
    ...
    async with async_playwright() as p:
        ...
        for shop_name, tasks in tasks_by_shop.items():
            async_tasks.append(process_shop_tasks(browser, shop_name, tasks))
